...
android {
    ...
    namespace = "githubprofilesearcher.caiodev.com.br.githubprofilesearcher.resources"
}

group = "githubprofilesearcher.caiodev.com.br.githubprofilesearcher.resources"
