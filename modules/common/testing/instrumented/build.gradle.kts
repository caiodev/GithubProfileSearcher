...
android {
    ...
    namespace = "githubprofilesearcher.caiodev.com.br.githubprofilesearcher.instrumented"
}

dependencies {
    api(projects.modules.common.testing.testing) { because("Common Testing Module") }
    api(dep.bundles.instrumentedTest)
}

group = "githubprofilesearcher.caiodev.com.br.githubprofilesearcher.instrumented"
